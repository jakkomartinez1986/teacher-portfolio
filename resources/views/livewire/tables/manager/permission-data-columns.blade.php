...
<thead>
    <tr class="text-xs border-b uppercase font-semibold tracking-wider">
        ...
        <th class="px-4 py-3">
            <a wire:click.prevent="sortBy('module')" href="#" class="hover:underline flex items-center gap-1">
                Modulo 
                @include('components.app-components.sort-icon', ['field' => 'module'])
            </a>
        </th>
        <th class="px-4 py-3">
        ...
        <th class="px-4 py-3">
            <a wire:click.prevent="sortBy('label')" href="#" class="hover:underline flex items-center gap-1">
                Descripcion 
                @include('components.app-components.sort-icon', ['field' => 'label'])
            </a>
        </th>
            ...
            <td class="px-4 py-3">
                <div class="flex items-center space-x-2">
                    <flux:dropdown position="bottom" align="end" offset="-15">
                        ...
                        <flux:menu>
                            <flux:menu.item icon="eye" size="sm" href="{{route('admin.permissions.show', $item)}}">Ver</flux:menu.item>
                            @can('editar-'.$modelactive)
                                <flux:menu.item icon="pencil" size="sm" href="{{route('admin.permissions.edit', $item->id)}}" >Editar</flux:menu.item>
                            @endcan
