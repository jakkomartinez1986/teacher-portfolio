            ...
            <td class="px-4 py-3">
                <div class="flex items-center space-x-2">
                    <flux:dropdown position="bottom" align="end" offset="-15">
                        ...
                        <flux:menu>
                            <flux:menu.item icon="eye" size="sm" href="{{route('settings.document-categories.show', $item)}}">Ver</flux:menu.item>
                            @can('editar-'.$modelactive)
                                <flux:menu.item icon="pencil" size="sm" href="{{route('settings.document-categories.edit', $item->id)}}" >Editar</flux:menu.item>
                            @endcan
