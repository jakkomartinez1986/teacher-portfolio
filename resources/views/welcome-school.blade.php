...
<body class="bg-gray-50">
  ...
  <header class="bg-white shadow-md sticky top-0 z-50">
    <div class="container mx-auto px-4 py-4 flex justify-between items-center">
      <div class="flex items-center">
        <img src="tu-escudo.png" alt="Escudo Vicente León" class="h-16 mr-4">
        <div>
  ...
  <section id="nosotros" class="py-16 bg-white">
    <div class="container mx-auto px-4">
      ...
      <div class="grid md:grid-cols-2 gap-12 items-center">
        <div>
          <h3 class="text-2xl font-bold text-gray-800 mb-4">UN LEGADO DE 100 AÑOS</h3>
          <p class="text-gray-600 mb-4">Fundada en 1923, la Unidad Educativa Vicente León ha sido pionera en la educación de calidad en Latacunga, formando generaciones de profesionales y ciudadanos comprometidos con el desarrollo del país.</p>
          <p class="text-gray-600 mb-6">Nuestro lema "Juventud Adelante" refleja el espíritu de superación y progreso que inculcamos en nuestros estudiantes.</p>
        ...
        <div class="relative hover-scale">
          <img src="https://images.unsplash.com/photo-1588072432836-e10032774350?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80" alt="Historia Vicente León" class="rounded-lg shadow-xl w-full">
      ...
      <div class="grid md:grid-cols-3 gap-8">
         ...
         <div class="bg-white rounded-lg overflow-hidden shadow-md hover-scale">
            <div class="h-48 overflow-hidden">
              <img src="https://images.unsplash.com/photo-1588072432836-e10032774350?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80" alt="Educación Básica" class="w-full h-full object-cover">
            </div>
            <div class="p-6">
        ...
        <div class="bg-white rounded-lg overflow-hidden shadow-md hover-scale">
          <div class="h-48 overflow-hidden">
            <img src="https://images.unsplash.com/photo-1523050854058-8df90110c9f1?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80" alt="Bachillerato General" class="w-full h-full object-cover">
          </div>
          <div class="p-6">
        ...
        <div class="bg-white rounded-lg overflow-hidden shadow-md hover-scale">
          <div class="h-48 overflow-hidden">
            <img src="https://images.unsplash.com/photo-1551269901-5c5e14c25df7?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80" alt="Bachillerato Técnico" class="w-full h-full object-cover">
          </div>
          <div class="p-6">
            ...
            <ul class="space-y-2 mb-6 text-gray-600">
              <li class="flex items-start">
                <i class="fas fa-check text-yellow-500 mr-2 mt-1"></i> Soporte Informatico
              </li>
              <li class="flex items-start">
  ...
  <section id="admisiones" class="py-16 bg-white">
    <div class="container mx-auto px-4">
      ...
      <div class="grid md:grid-cols-2 gap-12 items-center">
        <div class="relative hover-scale">
          <img src="https://images.unsplash.com/photo-1541178735493-479c1a27ed24?ixlib=rb-1.2.1&auto=format&fit=crop&w=1351&q=80" alt="Proceso de admisión" class="rounded-lg shadow-xl w-full">
        </div>
          ...
          <div class="space-y-6">
            <div class="flex items-start">
              ...
              <div>
                ...
                <p class="text-gray-600">Av. Vicente León S/N y Guayaquil, Latacunga, Ecuador</p>
              </div>
            </div>
            ...
            <div class="flex items-start">
              ...
              <div>
                ...
                <p class="text-gray-600">Lunes a Viernes: 7:30 - 16:30</p>
  ...
  <div class="h-96 bg-gray-200">
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3989.8000000000006!2d-78.650131000001!3d-0.921841!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMMKwNTYnMDAuMCJTIDc4wrAzNycwMC4wIlc!5e0!3m2!1sen!2sec!4v1620000000000!5m2!1sen!2sec" width="100%" height="100%" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
  </div>
    ...
    <div class="container mx-auto px-4">
      <div class="grid md:grid-cols-4 gap-8 mb-8">
        <div>
          ...
          <p class="text-gray-300 mb-4">Institución educativa con 100 años de tradición y excelencia en Latacunga.</p>
      ...
      <div class="border-t border-gray-700 pt-8 text-center text-gray-400">
        <p>&copy; Unidad Educativa Vicente León. Todos los derechos reservados.</p>
